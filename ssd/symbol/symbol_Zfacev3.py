...
def get_symbol_train(num_classes=1):
    ...
    # short cut:
    # pool2_shortcut = mx.symbol.Convolution(
        # data=pool2, kernel=(1, 1), num_filter=256, name="pool2_shortcut_proj_conv")
    # group 3
    ...
    from_layers = [relu3_3, relu4_3, relu7, relu8_2, relu9_2]
    sizes = [[0.04], [.08], [.12, .228], [.228, .336], [.336, .444]]
    ratios = [[1], [1], [1], [1,2,.5], [1,2,.5]]
    normalizations = [20, 20, -1, -1, -1 ]
